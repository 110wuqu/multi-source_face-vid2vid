...
class KPDetector(nn.Module):
    ...
    def __init__(self, block_expansion, feature_channel, num_kp, num_source, train, image_channel, max_features, reshape_channel, reshape_depth,
...
class HEEstimator(nn.Module):
    ...
    def __init__(self, block_expansion, feature_channel, num_kp, num_source, train, image_channel, max_features, num_bins=66, estimate_jacobian=True):
